...
export class ResetPasswordRequestService {
  ...
  sendResetPasswordEmail(emailDto: EmailDto): Observable<ApiResponse<void>> {
  ...
  confirmNewPassword(resetPasswordRequestDto: ResetPasswordRequestDto): Observable<ApiResponse<void>> {
    return this.http.post<ApiResponse<void>>(
